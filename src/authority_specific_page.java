...
/**
 * Servlet implementation class authority_specific_page
 */
@WebServlet("/authority_specific_page")
public class authority_specific_page extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public authority_specific_page() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("gotcha"+sub_category);
		 ...
		 final String PROFILE_PAGE ="<!DOCTYPE html>\n" + 
		 		...
		 		"                  <li><a href=\"Home\"><i class=\"fa fa-user fa-lg\"></i> Add Post</a></li>\n" + 
		 		"                  <li><a href=\"Home\"><i class=\"fa fa-user fa-lg\"></i> Delete Post</a></li>\n" + 
		 		"                </ul>\n" + 
				...
				"    var cards=\"\";\n" + 
				"      for (x in obj){\n" + 
				"         cards+=\"<li><a href=\\\"authority_specific_page?sub_category_name=\"+obj[x].sub_category+\"\\\">\"+obj[x].sub_category+\"</a></li>\";"+ 
				"      }\n" + 
				...
				"</script>"+
		 		...
		 		"    }\n" + 
		 		"  };\n" + 
		 		"  xhttp.open(\"GET\", \"authority_specific_page_json\", true);\n" + 
		 		"  xhttp.send();\n" + 
		 		"}\n" + 

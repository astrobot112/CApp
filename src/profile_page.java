	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String user_id = (String) session.getAttribute("id");
		 ...
		 final String PROFILE_PAGE="<html>\n" + 
				...
				"\n" + 
				"<body>\n" + 
				"	<div class=\"brand\">My Complaints</div>\n" + 
				"	<div class=\"nav-side-menu\">\n" + 
				"        <div class=\"menu-list\">\n" + 
				"    		<ul id=\"menu-content\" class=\"menu-content collapse out\">\n" + 
				"				<li data-toggle=\"collapse\" data-target=\"#service\" class=\"collapsed\">\n" + 
				"                	<a href=\"#\"><i class=\"fa fa-globe fa-lg\"></i> All Categories <span class=\"arrow\"></span></a>\n" + 
				"                </li>  \n" + 
				"                <ul class=\"sub-menu collapse\" id=\"service\">\n" + 
				//"                    <li><a href=\"user_specific_page?&sub_category=Hostel1&given_sub_cat=yes\">Hostel 1</a></li>\n" + 
				//"                    <li><a href=\"user_specific_page?&sub_category=Hostel2&given_sub_cat=yes\">Hostel 2</a></li>\n" + 
				//"                    <li><a href=\"user_specific_page?&sub_category=Hostel3&given_sub_cat=yes\">Hostel 3</a></li>\n" + 
				"                    <p id=\"getsubcat\"></p>\n"+
				"                </ul>\n" + 
				...
				"{upvote(upv,post_id); document.location.href=\"profile_page\";} "
				+ "</script>"+
				"\n" + 
				"</body>\n" + 
				"</html>";

...
/**
 * Servlet implementation class category_page
 */
@WebServlet("/category_page")
public class category_page extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String category = (String) session.getAttribute("category_name");
		 ...
		 final String PROFILE_PAGE="<html>\n" + 
					...
					"                	<a href=\"#\"><i class=\"fa fa-globe fa-lg\"></i> Sub Categories <span class=\"arrow\"></span></a>\n" + 
					"                </li>  \n" + 
					...
					"    var cards=\"\";\n" + 
					"      for (x in obj){\n" + 
					"         cards+=\"<li><a href=\\\"sub_category_page?sub_category_name=\"+obj[x].sub_category+\"\\\">\"+obj[x].sub_category+\"</a></li>\";"+ 
					"      }\n" + 
					"      document.getElementById(\"getsubcat\").innerHTML =cards ;\n" + 
					"    }\n" + 
					"  };\n" + 
					"  xhttp.open(\"GET\", \"sub_cat\", true);\n" + 
					"  xhttp.send();\n" + 
					"}\n" + 
					...
					"    }\n" + 
					"  };\n" + 
					"  xhttp.open(\"GET\", \"category_page_json\", true);\n" + 
					"  xhttp.send();\n" + 
					"}\n" + 
					...
					"{upvote(upv,post_id); document.location.href=\"category_page\";} "
					+ "</script>"+
					"</body>\n" + 
					"</html>";

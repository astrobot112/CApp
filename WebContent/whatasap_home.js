...
function insert_user()
{
	...
	Str="";
	Str=Str+user_id+" "+password+ " "+ user_name;
	//System.out.println("inside fun!!-");     
	if(password!=password_check)
		{
			document.getElementById("samepd").innerHTML="Enter same password";
			document.getElementById("error").innerHTML="";
		}
		else
		{
			document.getElementById("samepd").innerHTML="";
	var xhttp = new XMLHttpRequest();
 	...
 	xhttp.open("GET", "create_user?user_id="+user_id+"&password="+password
 			+"&user_name="+user_name+"&password_check="+password_check, true);     
 	xhttp.send();
}
};
